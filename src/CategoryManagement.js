  ...
  <div className="row">
    <div className="col-lg-4">
      <form style={formStyles} onSubmit={handleNewCategory}>
        ...
        <FloatingLabel style={{textAlign:'center'}}
      ...
      >
        <Form.Control
          ...
          value={newCategory}
          onChange={(e) => setNewCategory(e.target.value)}style={{padding:'7%',borderRadius:'5%',border:'3px solid lightgray'}}
          
          
        />
        </FloatingLabel>
        <div className="d-grid gap-4">
      <Button variant="info" size="lg" type='submit' style={{padding:'20px'}}>
          Add Category
        </Button>
        </div>
      </form>
