    ...
    <div className="row">
      <div className="col-lg-4">
        <form style={formStyles}>
          ...
          <InputGroup size="lg">
          <InputGroup.Text id="inputGroup-sizing-lg">ProdName:</InputGroup.Text>
        <Form.Control style={{padding:"4%"}} type="product" id="prodName" value={prodName}
        ...
        <InputGroup.Text id="inputGroup-sizing-lg">Price:</InputGroup.Text>
          <Form.Control style={{padding:"4%"}} type="number"id="Price" name="Price"value={price}
       ...
       <br/>
          ...
          <FormControl style={{padding:"4%"}} type="number" id="stock" name="stock" value={stock}
              onChange={(e) => setStock(e.target.value)}/>
         </InputGroup>
         <br/>
          <Form.Select style={{padding:"4%"}} size="lg"
            id="filterCategory"
          ...
          <Button
          style={{padding:'4%',width:'100%', fontSize:'25px',borderRadius:'8px',font:'10px9'}}
             variant="info"
             disabled={isLoading}
